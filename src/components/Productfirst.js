...
export default class Productfirst extends Component {
    ...
    // getProductDetails() {
    //     fetch('https://5ed296ce717d5f0016518314.mockapi.io/api/v1/products/"1"')
    //     .then(results => results.json())
    //     .then(results => this.setState({'productDetails': results}))
    // }
    ...
    //     fetch('https://5ed296ce717d5f0016518314.mockapi.io/api/v1/products/1')
    //     .then(response => response.json())
    //     .then(json => this.setState({ productDetails: json }))
    ...
    render() {
        return (
            ...
            //         return <h1 className="demo">{item.product_name}</h1>
            //         })
            //     }
            //  </ul>
